---
title: 'UNAH UK visit – March 2025'
date: 2025-03-16
author: jforrest
version: 1.0.0
category: visits
...
![FieldTripSchedule](/assets/posts/3.25EBA1.jpg)
...
A day visit was made to two sites: Welney Nature Reserve and Wicken Fen to become familiar with their characteristics - the nature of the landscape as well as the diversity and number of plant and bird species. 
The students were able to match satellite imagery taken into the field with ground conditions to confirm different information illustrated by the satellite images.
They were also able to appreciate the fragility of these unique ecosystems and also investigated the management techniques employed in an attempt to conserve the remaining fenlands.

Se realizó una visita de un día a dos sitios de interes: la Reserva Natural de Welney y Wicken Fen para familiarizarse con sus características: la naturaleza del paisaje, así como la diversidad y el número de especies de plantas y aves. 
El grupo fue capaz de cotejar las imágenes de satélite tomadas sobre el terreno con las condiciones del terreno para confirmar las distintas informaciones ilustradas por las imágenes de satélite.
También pudo apreciar la fragilidad de estos ecosistemas únicos e investigaron las técnicas de gestión empleadas en un intento de conservar los pantanos que quedan.
